 ...
 *   2005 Robert Harder - rob@iharder.net
 * 
	...
	public static String encodeObject(java.io.Serializable serializableObject, boolean breakLines) {
		...
		try {
			...
			try {
                ...
                logger.error("encodeObject(Serializable,boolean)",e);
			}
			try {
				b64os.close();
			} catch (Exception e) {
	...
	public static Object decodeToObject(String encodedObject) {
		...
		try {
			...
			try {
                ...
                logger.error("decodeToObject(String)",e);
			}
			try {
				ois.close();
			} catch (Exception e) {
        ...
        public static void main(String[] args) {
            for(String fileName:args) {
                try {
                    ...
                    InputStream is = new InputStream(fis,true,true);
                    FileOutputStream fos = new FileOutputStream(new File(fileName+".base64"));

 ...
 */
public class FuncStringEquals extends AbstractXPathFunction {
    private static Logger logger  = Logger.getLogger(FuncStringEquals.class);
    public static final transient String FUNCTION_NAME = "StringEquals";
    /**
    ...
    public Object evaluate(List args) throws XPathFunctionException {
        if(args.size()!=2) throw new XPathFunctionException("StringEquals requires exactly 2 parameters");

...
/**
 * Execute the DateAfter() function.<br/>
 * Usage: <tt>xem:DateAfter(date1,"date2")</tt><br/>
 * Returns <tt>TRUE</tt> if and only if <tt>date1</tt> is <strong>after</strong> and not equal <tt>date2</tt></br>
 * Dates are supposed to respect <tt>yyyy-MM-dd</tt> pattern
 */
public class FuncDateAfter extends AbstractXPathFunction {
	private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(FuncDateAfter.class);
	public static final transient String FUNCTION_NAME = "DateAfter";
    

    @Override
    public Object evaluate(List args) throws XPathFunctionException {
        if(args.size()!=2) throw new XPathFunctionException("DateAfter requires exactly 2 parameters");

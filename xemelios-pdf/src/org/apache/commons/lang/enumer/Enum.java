 ...
 */
package org.apache.commons.lang.enumer;
 ...
 * @author Mike Bowler
 * @since 1.0
 * @version $Id: Enum.java,v 1.1 2008/09/23 12:47:44 chm Exp $
 */
public abstract class Enum implements Comparable, Serializable {
    ...
    public final boolean equals(Object other) {
        if (other == this) {
            ...
            try {
                Method mth = other.getClass().getMethod("getName");
                String name = (String) mth.invoke(other);
